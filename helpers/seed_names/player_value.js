export function playerValue(rating, age = {}) {
    ...
    let ageFactor = 0.05; // Factor to adjust age influence
    const randomnessFactor = 0.15; // Factor to adjust randomness influence
    ...
    const ageInfluence = 1 + (Math.abs(ageGap) - 1) * ageFactor;
